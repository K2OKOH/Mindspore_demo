...
parser.add_argument('--save_path', dest='save_path', default='obs://xmj/PACS/MAD_IC/SaveModel', type=str)
...
Photo_DataSet_s2 = mindspore.dataset.GeneratorDataset(MyDatasets(data_path = args.dataset_path + 'photo_s2'), column_names=["image", "label"])
...
def train():
    ...
    for epoch in range(60):
        ...
        # 保存模型
        save_model(net, args.save_path + 'res_MV3_P.ckpt')
        print('>> PACS_P 保存完成')
